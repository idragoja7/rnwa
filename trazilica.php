...
$result2 = $con->query($sql);
 while($row = mysqli_fetch_array($result2)){
            ...
            $sqll="SELECT * FROM automobili where grad_id_grad=".$row['id_grad']."";
    ...
    while($roww = mysqli_fetch_array($result3)){
        $hint .= '<div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="img/slider/tiguan.jpg" alt="">
                            <div class="caption">
                                <h4 class="pull-right">'.$roww['cijena'].'€</h4>
                                <h4><a href="#">'.$roww['naziv'].'</a>
                                </h4>
                                <p>Gorivo:'.$roww['vrsta_goriva'].'</p>
								<p>'.$roww['opis_auta'].'</p>
                            </div>
...
echo $hint === "" ? "Oprostite,ali nemamo nijedno auto u tom gradu,pokušajte drugi grad" : $hint;
